...
const heroGradients = {
  light: [
    { left: "25%", top: "45%", width: "600px", height: "600px", color: "#FABD8F", opacity: "0.35", blur: "80px", rotate: "25deg" },
    { left: "65%", top: "55%", width: "500px", height: "500px", color: "#FFA726", opacity: "0.35", blur: "80px", rotate: "-15deg" },
    { left: "50%", top: "50%", width: "400px", height: "400px", color: "#FABD8F", opacity: "0.25", blur: "60px", rotate: "45deg" },
  ],
  dark: [
    { left: "35%", top: "45%", width: "600px", height: "600px", color: "#FABD8F", opacity: "0.35", blur: "80px", rotate: "25deg" },
    { left: "65%", top: "55%", width: "500px", height: "500px", color: "#FF9800", opacity: "0.35", blur: "80px", rotate: "-15deg" },
    { left: "50%", top: "50%", width: "400px", height: "400px", color: "#FABD8F", opacity: "0.25", blur: "60px", rotate: "45deg" },
  ],
};
...
const techGradients = {
  light: [
    { left: "25%", top: "35%", width: "550px", height: "550px", color: "#E34290", opacity: "0.30", blur: "90px", rotate: "15deg" },
    { left: "75%", top: "65%", width: "550px", height: "550px", color: "#F472B6", opacity: "0.30", blur: "90px", rotate: "-30deg" },
    { left: "55%", top: "45%", width: "400px", height: "400px", color: "#E34290", opacity: "0.25", blur: "70px", rotate: "75deg" },
  ],
  dark: [
    { left: "25%", top: "15%", width: "550px", height: "550px", color: "#E34290", opacity: "0.30", blur: "90px", rotate: "15deg" },
    { left: "75%", top: "25%", width: "550px", height: "550px", color: "#F472B6", opacity: "0.30", blur: "90px", rotate: "-30deg" },
    { left: "55%", top: "35%", width: "400px", height: "400px", color: "#E34290", opacity: "0.25", blur: "70px", rotate: "75deg" },
  ],
};
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center pb-16">
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center pb-16">
            ...
            <p className="text-lg text-[#404551] dark:text-gray-300 max-w-5xl mx-auto px-4">
              This gap creates interesting product challenges: How do you build
              scheduling that works seamlessly on mobile? How do you integrate
              with social platforms? How do you design for users who may never
              visit a traditional website? These questions drive our development
              decisions, and we document our approach in the blog.
            </p>
          </div>
        </div>
